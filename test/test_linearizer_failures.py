...
class TestLinearizerFailures(unittest.TestCase):
  ...
  def test_failure_1(self):
    ...
    assert helper_test_lin(Linearizer(ast), [], fixed_platforms=["CPU", "TORCH", "CLANG", "METAL", "GPU", "LLVM"])
  ...
  @unittest.skipUnless(Device.DEFAULT in ["CUDA", "METAL", "GPU"], "fails on these backends")
  ...
  @unittest.skipUnless(Device.DEFAULT in ["CLANG"], "fails on these backends")
