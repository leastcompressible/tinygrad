...
core_dtypes = list(v for v in DTYPES_DICT.values() if v != dtypes.pyint)
...
def get_available_cast_dtypes(dtype: DType) -> List[DType]:
  ...
  return [v for v in core_dtypes if v != dtype and is_dtype_supported(v)] # dont cast internal dtypes
