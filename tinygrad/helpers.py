...
class dtypes:
  ...
  int8: Final[DType] = DType(2, 1, "char", np.int8)
  uint8: Final[DType] = DType(3, 1, "unsigned char", np.uint8)
  int16: Final[DType] = DType(4, 2, "short", np.int16)
  uint16: Final[DType] = DType(5, 2, "unsigned short", np.uint16)
  int32: Final[DType] = DType(6, 4, "int", np.int32)
  uint32: Final[DType] = DType(7, 4, "unsigned int", np.uint32)
  int64: Final[DType] = DType(8, 8, "long", np.int64)
  uint64: Final[DType] = DType(9, 8, "unsigned long", np.uint64)
  float16: Final[DType] = DType(11, 2, "half", np.float16)
  # NOTE: bfloat16 isn't supported in numpy
  bfloat16: Final[DType] = DType(11, 2, "__bf16", None)
  float32: Final[DType] = DType(12, 4, "float", np.float32)
  float64: Final[DType] = DType(13, 8, "double", np.float64)
  ...
  _int_scalar = DType(1, 0, "", None)
  _float_scalar = DType(10, 0, "", None)
...
promo_lattice = { dtypes.bool: [dtypes._int_scalar],
  dtypes._int_scalar: [dtypes.uint8, dtypes.int8], dtypes.int8: [dtypes.int16], dtypes.int16: [dtypes.int32], dtypes.int32: [dtypes.int64], dtypes.int64: [dtypes._float_scalar],
  dtypes.uint8: [dtypes.int16, dtypes.uint16], dtypes.uint16: [dtypes.int32, dtypes.uint32], dtypes.uint32: [dtypes.int64, dtypes.uint64], dtypes.uint64: [dtypes._float_scalar],
  dtypes._float_scalar: [dtypes.float16, dtypes.bfloat16], dtypes.float16: [dtypes.float32], dtypes.bfloat16: [dtypes.float32], dtypes.float32: [dtypes.float64], }
...
def resolve_scalar_dtype(dtype:DType, default_float_type:DType) -> DType: return dtypes.int32 if dtype == dtypes._int_scalar else least_upper_dtype(default_float_type, dtype) if dtype == dtypes._float_scalar else dtype
