...
InterpretedFlopCounter: Dict[Op, Callable] = {
  ...
  **{op:lambda self,axis: FlopCounter(tuple(1 if i in axis[0] else s for i,s in enumerate(self.shape)), self.consume_flops() + prod(self.shape), self.mem) for op in ReduceOps},  # noqa: E501
