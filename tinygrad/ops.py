...
class UOp(MathTrait):
  ...
  def _min_max(self) -> Tuple[ConstType, ConstType]:
    ...
    if self.op is UOps.DEFINE_VAR and self.arg: return self.arg[1].vmin, self.arg[2].vmax
    ...
    # NOTE: arg[1] is int or Variable
    if self.op is UOps.SPECIAL: return 0, self.arg[1]-1 if isinstance(self.arg[1], int) else self.arg[1].max-1
