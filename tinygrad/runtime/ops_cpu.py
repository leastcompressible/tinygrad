...
type_map = {np.bool_: dtypes.bool, np.int8: dtypes.int8, np.uint8: dtypes.uint8, np.int16: dtypes.int16, np.uint16: dtypes.uint16,
            np.int32: dtypes.int32, np.uint32: dtypes.uint32, np.int64: dtypes.int64, np.uint64: dtypes.uint64,
            np.float16: dtypes.float16, np.float32: dtypes.float32, np.float64: dtypes.float64}
inverse_type_map = {v: k for k,v in type_map.items()}
inverse_type_map.update({dtypes.bfloat16: None})
